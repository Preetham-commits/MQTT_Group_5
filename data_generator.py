...
class DataGenerator:
    ...
    def generate(self):
        ...
        if self.pattern_type == "normal":
            ...
            # Sinusoidal pattern
            value = self.base_value + self.variance * math.sin(self.time_offset * 0.1) # Now uses imported math
    ...
    def generate_wild_data(self):
        ...
        """
        # Generate wild data significantly different from the base value
        wild_multiplier = random.uniform(5, 15) # Adjust range as needed
        if random.random() < 0.5: # Randomly make it very high or very low
